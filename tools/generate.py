...
repo_path = "D:\\Repositories\\Readar"
apks_path = "D:\\Repositories\\Readar\\build\\app\\outputs\\flutter-apk"
windows_release_path = (
    "D:\\Repositories\\Readar\\build\\windows\\x64\\runner\\Release"
)
downloads_path = "D:\\Ruida\\Downloads"
dll_path = "D:\\Repositories\\Readar\\tools\\dll"
iss_path = "D:\\Repositories\\Readar\\tools\\Readar.iss"
    ...
    for root, dirs, files in os.walk(apks_path):
        for file in files:
            ...
            if match:
                ...
                if abi == "":
                    new_file = f"Readar-{version}.apk"
                else:
                    new_file = f"Readar-{version}-{abi}.apk"
...
def zip_windows(version):
    ...
    zip_path = os.path.join(get_downloads_path(version), "Readar-" + version + ".zip")
