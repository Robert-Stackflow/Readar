...
class FeedSetting {
  ...
  BoolType? autoReadOnScrollOutOfVisibleArea;
  BoolType? autoReadOnEnterVisibleArea;
  BoolType? autoReadOnHover;
  ClusterType? clusterType;
  //详情页布局
  BoolType? showTocButton;
  BoolType? showRelatedArticles;
  BoolType? showImageAlt;
  BoolType? showGalleryButton;
  ...
  FeedSetting({
    ...
    this.autoReadOnScrollOutOfVisibleArea,
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        ...
        'showAiAbstract': autoAISummary?.index,
        ...
        'autoReadOnScrollOutOfVisibleArea':
            autoReadOnScrollOutOfVisibleArea?.index,
  ...
  factory FeedSetting.fromJson(Map<String, dynamic> json) => FeedSetting(
        ...
        removeDuplicateArticles: json['removeDuplicateArticles'] != null
            ...
            : null,
        autoReadOnScrollOutOfVisibleArea: json['autoReadOnScroll'] != null
