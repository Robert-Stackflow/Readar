...
class FileUtil {
  ...
  static Future<ReleaseAsset> getAndroidAsset(
    ...
    ReleaseAsset universalAsset = assets.firstWhere((element) {
      return [
        'Readar-$latestVersion.apk',
        'Readar-$latestVersion-android-universal.apk'
    ...
    try {
      ...
      for (var asset in assets) {
        String abi =
            asset.name.split("Readar-$latestVersion-").last.split(".").first;
  ...
  static WindowsVersion checkWindowsVersion() {
    ...
    if (result == WIN32_ERROR.ERROR_SUCCESS) {
      ...
      if (queryResult == WIN32_ERROR.ERROR_SUCCESS) {
        ...
        final installPath =
            "${installPathPtr.cast<Utf16>().toDartString()}\\Readar.exe";
        ILogger.info("Readar",
