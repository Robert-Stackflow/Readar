...
class ThemeTransition extends StatefulWidget {
  ...
  @override
  ThemeTransitionState createState() => ThemeTransitionState();
}

class ThemeTransitionState extends State<ThemeTransition>
    ...
    Widget body(int index) {
      return ValueListenableBuilder<bool>(
          ...
          builder: (BuildContext context, bool isDark, Widget? child) {
            return Theme(
                data: index == 2
                    ? AppTheme.getTheme(isDarkMode: !isDarkVisible)
                    : AppTheme.getTheme(isDarkMode: isDarkVisible),
