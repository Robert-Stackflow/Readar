...
import 'package:readar/Widgets/Custom/multi_tappable.dart';
...
/// To update from [MyBottomNavigationBar] to [NavigationBar], you will
/// need to make the following changes.
///
/// 1. Instead of using [MyBottomNavigationBar.items], which
...
///
/// ## Using [MyBottomNavigationBar]
///
/// {@tool dartpad}
/// This example shows a [MyBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [MyBottomNavigationBar] has three [BottomNavigationBarItem]
...
///
/// {@tool dartpad}
/// This example shows how you would migrate the above [MyBottomNavigationBar]
...
/// {@tool dartpad}
/// This example shows a [MyBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [MyBottomNavigationBar] has four [BottomNavigationBarItem]
...
///
/// {@tool dartpad}
/// This example shows [MyBottomNavigationBar] used in a [Scaffold] Widget with
...
class MyBottomNavigationBar extends StatefulWidget {
  ...
  /// This flag is controlling how [MyBottomNavigationBar] is going to use
