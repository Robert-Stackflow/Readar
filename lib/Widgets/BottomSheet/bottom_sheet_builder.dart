...
///    function.
///
/// The [BottomSheetBuilder] widget itself is rarely used directly. Instead, prefer to
...
class BottomSheetBuilder extends StatefulWidget {
  ...
  @override
  BottomSheetBuilderState createState() => BottomSheetBuilderState();

  /// Creates an [AnimationController] suitable for a
  /// [bottom_sheet_builder.animationController].
  ///
...
class BottomSheetBuilderState extends State<BottomSheetBuilder> {
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  AnimationController createAnimationController() {
    ...
    _animationController =
        BottomSheetBuilder.createAnimationController(navigator!.overlay!);
...
/// sheet is closed.
///
/// The `isScrollControlled` parameter specifies whether this is a custom_page_route.dart for
...
/// display the [BottomSheetBuilder] when set to `true`. This is useful in the case
/// that a modal [BottomSheetBuilder] needs to be displayed above all other content
...
/// See also:
///
///  * [BottomSheetBuilder], which becomes the parent of the widget returned by the
