...
import 'package:readar/Providers/Providers/rss_service_provider.dart';
...
import '../Database/Dao/rss_service_dao.dart';
...
class MainScreenState extends State<MainScreen>
              ...
              builder: (context, hideNavigator, child) => Column(
                ...
                children: [
                  ...
                  ToolButton(
                    context: context,
                    selected:
                        hideNavigator && sidebarChoice == SideBarChoice.History,
                  ...
                  ToolButton(
                    context: context,
                    selected:
                        hideNavigator && sidebarChoice == SideBarChoice.Explore,
  ...
  Future<void> initRssServices() async {
    List<RssServiceModel> rssServices = await RssServiceDao.instance.queryAll();
    globalRssProvider.addServices(rssServices);
  }
